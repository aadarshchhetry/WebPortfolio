        ...
        <div class="album py-5 bg-light">
            ...
            <div class="row">
                    ...
                    <a href="https://www.linkedin.com/in/aadarsh-chhetry-54ba4a166/">
                        <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><rect width="100%" height="100%" fill="#0072b1"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em">LinkedIn</text></svg> 
                    </a>                   
                    </div>
                    </div>
                ...
                <a href="https://www.instagram.com/aaadarshchhetry/?hl=en">
                    <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><rect width="100%" height="100%" fill="#f2003c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em">Instagram</text></svg>                    
                    </a></div>
                </div>
